...
export class AddItemComponent implements OnInit {
  ...
  /* Post the book data */
  public postBookData(bookTitle:any, bookIsbn:any, sector:any, author:any, publisher:any, pageCount:any) {
...
let booksDataLength = data.length + 1;
  ...
  /* Post the DVD Data */
  public postDvdData(dvdTitle:any, dvdIsbn:any, dvdSector:any, producer:any, language:any, subtitles:any, actors:any, duration:any) {
